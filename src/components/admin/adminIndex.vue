...
export default {
    data () {
        return {
            ...
            interval: null,
            systemList: [
                {text: '邮件管理',icon: 'icon-youjian',color: 'bgc-blue4',class: '',file: 'email',fileName: 'MRF邮件管理制度.pdf'},
                {text: 'KPI考核',icon: 'icon-KPIguanli',color: 'bgc-purple1',class: '',file: 'kpI',fileName: 'KPI考核管理制度.pdf'},
                {text: '入职管理',icon: 'icon-yuangongruzhi',color: 'bgc-or1',class: '',file: 'entry',fileName: 'MRF入职管理制度.pdf'},
                {text: '转正管理',icon: 'icon-zhuanzheng1',color: 'bgc-green2',class: '',file: 'regular',fileName: 'MRF转正管理制度.pdf'},
                {text: '离职管理',icon: 'icon-lizhi1',color: 'bgc-red2',class: '',file: 'dimission',fileName: 'MRF离职管理制度.pdf'},
                {text: '考勤管理',icon: 'icon-baobeikaoqin',color: 'bgc-purple1',class: '',file: 'check',fileName: 'MRF考勤管理制度.pdf'},
                {text: '会议管理',icon: 'icon-huiyishi',color: 'bgc-or1',class: '',file: 'meeting',fileName: 'MRF会议管理制度.pdf'},
                {text: '采购管理',icon: 'icon-caigouguanli-',color: 'bgc-green2',class: '',file: 'purchase',fileName: 'MRF采购管理制度.pdf'},
                {text: '招聘管理',icon: 'icon-zhaopin',color: 'bgc-red2',class: '',file: 'invite',fileName: 'MRF招聘管理制度终版.pdf'},
            ],
            periodicals: [
